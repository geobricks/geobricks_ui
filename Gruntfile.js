...
module.exports = function (grunt) {
    ...
    var schema_dir = 'resources/schemas/';
    ...
    grunt.registerTask('default', 'Create JSON configuration file from JSON Schema.', function() {
        ...
        /* Load JSON Schema. */
        var schema = grunt.file.readJSON(schema_dir + 'configuration_schema.json', [, {
            encoding: 'utf8'
        }]);
        ...
        /* Write JSON. */
        grunt.file.write(output_dir + 'geobricks.json', JSON.stringify(json), [, {encoding: 'utf8'}]);
